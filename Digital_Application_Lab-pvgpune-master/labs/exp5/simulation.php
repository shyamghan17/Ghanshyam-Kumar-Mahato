      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <h3 style="margin-top:5%">Simulation</h3>
            ...
            <iframe id="bracket" style="width:100%;vertical-align:top;z-index:-1" frameborder="0"
                    allowfullscreen  scrolling="auto" allowtransparency="true" src="sim.html" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" ></iframe>
        </section>
        <!-- /.content -->
      </div>
...
<script src="../../src/gates.ob.js"></script>
    <script src="../../src/animation.ob.js"></script>
    <script src="../../src/carwiper.ob.js"></script>
<!-- ./wrapper -->
<!-- jQuery 2.2.3 -->
