    ...
    <head>
        ...
        <script>
            window.onload = function () {
                document.getElementById("posttest").className = "active treeview";
            }
        </script>
    </head>
        ...
        <section class="content">
          ...
          <p class="MsoNormal" style="text-align:justify">
            ...
            <iframe id="bracket" style="width:100%;vertical-align:top;z-index:-1" frameborder="0"
                    allowfullscreen  scrolling="auto" allowtransparency="true" src="post.html" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" ></iframe>
          </p>
        </section>
        <!-- /.content -->
      </div>
