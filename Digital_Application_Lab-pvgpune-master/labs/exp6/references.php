    ...
    <head>
        ...
        <script>
            window.onload = function () {
                document.getElementById("ref").className = "active treeview";
            }
        </script>
    </head>
          ...
          <p class="MsoNormal" style="text-align:justify">
           ...
           <!--Reference content goes here -->
            <iframe id="bracket" style="width:100%;vertical-align:top;z-index:-1" frameborder="0"
                    allowfullscreen  scrolling="auto" allowtransparency="true" src="ref.htm" onload="this.style.height=this.contentDocument.body.scrollHeight +'px';" ></iframe>
          </p>
        </section>
        <!-- /.content -->
      </div>
