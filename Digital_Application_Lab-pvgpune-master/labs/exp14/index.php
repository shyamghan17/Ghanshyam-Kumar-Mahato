          ...
          <section class="content-header">
            ...
            <!-- Content Header (Page header) -->
                ...
                <h1 align="center">
                    ...
                    <!--Aim of experiment -->
                        Aim: To understand the design of a half adder using two input gates and simulate the design using a generalized simulator framework built for only two input logic gates.
                    </p>
                </section>
            <!-- /.content -->
            </div>
