...
* Updated [SCAYT](http://ckeditor.com/addon/scayt) (Spell Check As You Type):
	...
	- Fixed issues:
		...
		* [#108](https://github.com/WebSpellChecker/ckeditor-plugin-scayt/issues/108): Latest SCAYT copies the ID of the editor element to the object.
...
* [#13790](https://dev.ckeditor.com/ticket/13790): Fixed: It is not possible to destroy the editor `<object>` after the editor was detached from DOM. Thanks to [Stefan Rijnhart](https://github.com/StefanRijnhart)!
...
* [#13771](http://dev.ckeditor.com/ticket/13771): Fixed: The `contents.css` style is not used if the [object Editing Area](http://ckeditor.com/addon/wysiwygarea) plugin is missing.
...
* [#13554](http://dev.ckeditor.com/ticket/13554): [Edge] Fixed: Paste dialog's object does not receive focus on show.
...
* [#13131](http://dev.ckeditor.com/ticket/13131): Fixed: The [Code Snippet](http://ckeditor.com/addon/codesnippet) plugin cannot be used without the [object Editing Area](http://ckeditor.com/addon/wysiwygarea) plugin.
* [#9086](http://dev.ckeditor.com/ticket/9086): Fixed: Invalid ARIA property used on paste area `<object>`.
...
* [#12812](http://dev.ckeditor.com/ticket/12812): Fixed: An uncaught security exception is thrown when [Line Utilities](http://ckeditor.com/addon/lineutils) are used in an inline editor loaded in a cross-domain `object`. Thanks to [Vitaliy Zurian](https://github.com/thecatontheflat)!
...
* [#11121](http://dev.ckeditor.com/ticket/11121): [Firefox] Fixed: High Contrast mode is enabled when the editor is loaded in a hidden object.
...
* [#10937](http://dev.ckeditor.com/ticket/10937): [Mathematical Formulas](http://ckeditor.com/addon/mathjax) widget improvements:
  ...
  * applying paragraph changes (like font color change) to object ([#10841](http://dev.ckeditor.com/ticket/10841)),
...
* [#11110](http://dev.ckeditor.com/ticket/11110): Fixed: object and Flash objects are being incorrectly pasted in certain conditions.
...
* [#10610](http://dev.ckeditor.com/ticket/10610): [`CKEDITOR.dialog.addobject()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dialog-static-method-addobject) incorrectly sets the object size in dialog windows.
